...
import com.citec.demo.shop.creator.UserCreator;
...
public class UserRepositoryTests {
    ...
    public void whenFindByIdThenReturnUser() {
        ...
        entityManager.persistAndFlush(testObject);
        Optional<User> user = userRepository.findById(testObject.getId());
        assertTrue(user.isPresent() && user.get().getId().equals(testObject.getId()));
    }
